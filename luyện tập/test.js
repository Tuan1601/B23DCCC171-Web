class SinhVien {
  ...
  toString() {
    return `${this.maSV},${this.hoTen},${this.gioiTinh},${this.ngaySinh},${this.queQuan}`;
  }


  static fromString(string) {
    const [maSV, hoTen, gioiTinh, ngaySinh, queQuan] = string.split(",");
    return new SinhVien(maSV, hoTen, gioiTinh, ngaySinh, queQuan);
  }
}
...
class QuanLySinhVien {
  ...
  getStudentsFromStorage() {
    ...
    return students
      .split(";")
      .map((studentString) => SinhVien.fromString(studentString));
  }

  saveToStorage() {
    const studentsString = this.students
